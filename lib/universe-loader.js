// universe-loader.js
// -----------------------------------------------------------------------------
// Loads the Tradeable Universe from the paper-trading tracker workbook and
// exposes filtered views for the Signa-driven channel feeds.
//
...
//
// This module only READS the workbook. It does not mutate it. Substitution of
...
// Workbook lives in the sibling paper-trading directory.
...
// Truthy-cell coercion: xlsx may give booleans, 1/0, "TRUE"/"yes", etc.
function toBool(v) {
...
function loadUniverse() {
  ...
  if (!ws) {
    throw new Error(
      `universe-loader: sheet "${SHEET_NAME}" not found in ${WORKBOOK_PATH}. ` +
...
export { SIGNA_SUPPORTED_CLASSES, SKIP_TICKERS, WORKBOOK_PATH, SHEET_NAME };
